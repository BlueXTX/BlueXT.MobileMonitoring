...
namespace BlueXT.MobileMonitoring.Migrations
{
    ...
    [Migration("20230720093346_DeviceStatisticToDeviceEvent_Relation_Created")]
    partial class DeviceStatisticToDeviceEventRelationCreated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueXT.MobileMonitoring.DeviceEvents.DeviceEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("DeviceStatisticId")
                        .HasColumnType("uuid")
                        .HasColumnName("device_statistic_id");
                    ...
                    b.HasIndex("DeviceStatisticId");

                    b.ToTable("app_device_event", (string)null);
                });

            modelBuilder.Entity("BlueXT.MobileMonitoring.DeviceStatistics.DeviceStatistic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("app_device_statistic", (string)null);
                });
            ...
            modelBuilder.Entity("BlueXT.MobileMonitoring.DeviceEvents.DeviceEvent", b =>
                {
                    b.HasOne("BlueXT.MobileMonitoring.DeviceStatistics.DeviceStatistic", null)
                        .WithMany("DeviceEvents")
                        .HasForeignKey("DeviceStatisticId")
